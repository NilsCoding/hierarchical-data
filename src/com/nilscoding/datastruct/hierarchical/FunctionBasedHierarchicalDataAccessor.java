...
public final class FunctionBasedHierarchicalDataAccessor<K,T> implements IHierarchyDataAccessor<K, T> {
     ...
     */
    public static <K,T> FunctionBasedHierarchicalDataAccessor<K,T> of(Function<T,K> keyFnc, Function<T,K> parentKeyFnc, Function<T,List<T>> childReadFnc, BiConsumer<T,List<T>> childWriteFnc) {
